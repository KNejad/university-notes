...
public class TaskClient
{
  public static void main(String args[]) throws RemoteException
  {
    ...
    try 
    {
      ...
      ExecutionServiceInterface taskservice = (ExecutionServiceInterface)Naming.lookup( regURL );
      ...
      String taskResult = (String)taskservice.doTask (new RepeatLinesTask(message, 3));
