...
public final class UseIntegerQueue {
	...
	public static final void main(String[] args) {
		...
		while (choice != 'q') {
			...
			switch (choice) {
				case 'a':
					try {
						thequeue.push(Integer.parseInt(console.readLine("Please enter an integer: ")));
					}
					catch (NumberFormatException e) {
						console.printf("Sorry, you have to enter an integer!\n\n");
					}
