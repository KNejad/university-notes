...
\abstract{
  Classification of time series segments into different categories (e.g. linear line) can be done with a number of methods.
  One of these methods is by using Neural Networks.
  This paper aims to compare different Neural Network designs to solve this problem.
  The attributes which are being assessed are: Activation functions, number of layers and optimisers.
}
